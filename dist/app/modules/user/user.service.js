...
const getUsersService = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Users retrieved failed');
    }
    return result;
});
...
const getUserService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'User retrieved failed');
    }
    return result;
});
...
const deleteUserService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'User deleted failed');
    }
    return result;
});
